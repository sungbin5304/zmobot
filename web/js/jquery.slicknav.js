;(function($, document, window) {
  ...
  Plugin.prototype.init = function() {
    ...
    $this.btn = $(
        [
          '<' + settings.parentTag +
          ' aria-haspopup="true" role="button" tabindex="0" class="' + prefix +
          '_btn ' + prefix + '_collapsed">',
    ...
    $(items).each(function() {
      ...
      if (data.children.length > 0) {
        ...
        if ((!settings.allowParentLinks || settings.nestedParentLinks) ||
          ...
          $(nodes).
              wrapAll('<span class="' + prefix + '_parent-link ' + prefix +
                  '_row"/>').
              parent();
  ...
  Plugin.prototype._visibilityToggle = function(
      el, parent, animate, trigger, init) {
    var $this = this;
    var settings = $this.settings;
    ...
    if (el.hasClass(prefix + '_hidden')) {
      ...
      if (settings.animations === 'jquery') {
        el.stop(true, true).
            slideDown(duration, settings.easingOpen, function() {
      ...
      if (settings.animations === 'jquery') {
        el.stop(true, true).
            slideUp(duration, this.settings.easingClose, function() {
